...
# ===================== НАСТРОЙКИ =====================
OLLAMA_MODEL = "qwen3.6"          # Рекомендую: "qwen3.6:8b" — если медленно
...
class OrganizerApp(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title(f"🗃️ Органайзер — {OLLAMA_MODEL}")
...
Ответ **строго** в JSON:
{
  ...
  "description": "• Группа1: количество\n• Группа2: количество\n..."
    ...
    def finish_batch(self):
        self.refresh_grid()
        self.title_label.configure(text=f"🗃️ Органайзер — {OLLAMA_MODEL}")
